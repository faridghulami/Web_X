...
#Fancy banner :p
print ('''---------------------------------------------------------------------------
                          \033[37mMade with \033[91m<3\033[37m Farid Ghulami\033[1;m''')

print ('''\n  I am not responsible for your shit and if you get some error while
 running Web_X, there are good chances that target isn't responding.\n''')
print ('\033[1;31m--------------------------------------------------------------------------\033[1;m\n')

try:
    target = target.replace('https://', '') #Removes https://
except:
    print ('\033[1;31m[-]\033[1;m -u argument is not supplied. Enter python Web_X -h for help')
    quit()
